...
+(MessageObject *)messageFromDictionary:(NSDictionary *)aDic {
    ...
    [message setName:[NSString stringWithFormat:@"%@",[aDic objectForKey:M_Name]]];
    [message setUserId:[NSString stringWithFormat:@"%@",[aDic objectForKey:M_Userid]]];
    ...
    [message setReplyCount:[NSString stringWithFormat:@"%@",[aDic objectForKey:M_replyCount]]];
    ...
    [message setUserType:[NSString stringWithFormat:@"%@",[aDic objectForKey:M_userType]]];
