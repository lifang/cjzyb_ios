 ...
 * 管理作业界面
 */
@interface HomeworkViewController : UIViewController<UICollectionViewDataSource,UICollectionViewDelegate,HomeworkDailyCollectionViewControllerDelegate,ASIHTTPRequestDelegate,UIAlertViewDelegate>
///显示历史任务
